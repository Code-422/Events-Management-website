...
`$ git clone https://github.com/Code-422/Events-Management-website.git` <br/>
...
`$ git remote add upstream https://github.com/Code-422/Events-Management-website.git` <br/>
